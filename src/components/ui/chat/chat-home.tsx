  ...
  return (
    <div className={cn('flex h-dvh flex-col bg-gradient-to-b', theme === 'dark' ? 'from-gray-900 to-gray-800 text-white' : 'from-blue-50 to-white text-gray-900')}>
      <div className='flex h-full flex-col rounded-none border-none bg-transparent'>
        ...
        <ScrollArea className='h-[calc(100dvh-122px)] flex-1'>
          <div className={cn('flex-1 space-y-4 p-4', theme === 'dark' ? 'bg-gray-900/30' : 'bg-white/30')}>
        ...
        <div className={cn('border-t p-4 backdrop-blur-sm', theme === 'dark' ? 'border-gray-700 bg-gray-900/80' : 'border-gray-200 bg-white/80')}>
          ...
          <form onSubmit={onSubmit} className='flex w-full gap-2'>
            ...
            <Textarea
              className={cn(
                'max-h-[120px] min-h-[40px] flex-1 resize-none py-2',
                theme === 'dark' ? 'border-gray-700 bg-gray-800 text-white focus-visible:ring-blue-500' : 'border-gray-200 bg-white text-gray-900 focus-visible:ring-blue-500'
              )}
              value={input}
